...
```sh
pip install "git+https://github.com/kbizme/Kotak-neo-api-v2.git#egg=neo_api_client"
```

If you are updating your package please use below command to install
```sh
pip install --force-reinstall "git+https://github.com/kbizme/Kotak-neo-api-v2"
```
